...
let nameGreeting = nameCheck('Seth')
...
function theEliminator(people, gone) {
...
console.log(emailCheck('oof@eep.com'))
...
//I didn't  see this one, and have already made the function to not make this error
